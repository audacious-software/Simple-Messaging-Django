...
def incremental_backup(parameters):
    ...
    dumpdata_apps = (
        'simple_messaging.OutgoingMessage',
        'simple_messaging.IncomingMessage',
        'simple_messaging.IncomingMessageMedia',
    )

    prefix = 'simple_messaging_backup_' + settings.ALLOWED_HOSTS[0]
    ...
    for app in dumpdata_apps:
        logger.info('[simple_messaging] Backing up %s...', app)
        sys.stdout.flush()
