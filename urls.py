...
from .views import incoming_message_request, simple_messaging_ui, simple_messaging_messages_json, \
                   ...
                   dashboard_unknown_messages_log, dashboard_upcoming_messages_log, simple_messaging_add_label_json
...
urlpatterns = [
    ...
    url(r'^add-label.json$', simple_messaging_add_label_json, name='simple_messaging_add_label_json'),
